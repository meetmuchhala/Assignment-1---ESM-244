...
Date: Records the date of observation.
Coho: Indicates the passage count of Coho salmon.
Jack Coho: Represents the passage count of Jack Coho salmon.
Steelhead: Denotes the passage count of Steelhead salmon.


### Dataset Citation:

Provider: Willamette Partnership
Title: Willamette Fish Passage Data
URL: Willamette Fish Passage Data
Date Accessed: February 6, 2024
Purpose of Analysis:
...
- Select relevant columns and convert them into a time series object.
...
grid_combined <- plot_grid(seasonplot_coho, seasonplot_jackcoho, seasonplot_steelhead, nrow = 3) 
grid_combined
```

## Part 3: Annual Counts
